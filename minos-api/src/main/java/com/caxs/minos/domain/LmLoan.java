 ...
 */
public class LmLoan implements Serializable {
	 ...
	 * 是否上报征信:Y;上报 N:不上报
	 */
	private String pbcInd;
	/**
	 * 渠道来源
	 */
	private String placeCde;
	/**
	 * 信托计划代码
	 */
	...
	/**
	 * 设置：支付类型SELF: 自主支付,TRUS: 受托支付
	 */
	public void setPayTyp(String payTyp) {
		this.payTyp = payTyp;
	}
	/**
	 * 获取：支付类型SELF: 自主支付,TRUS: 受托支付
	 */
	...
	/**
	 * 设置：是否上报征信:Y;上报 N:不上报
	 */
	public void setPbcInd(String pbcInd) {
		this.pbcInd = pbcInd;
	}
	/**
	 * 获取：是否上报征信:Y;上报 N:不上报
	 */
