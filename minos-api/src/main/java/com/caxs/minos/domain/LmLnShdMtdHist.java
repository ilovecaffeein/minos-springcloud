 ...
 */
public class LmLnShdMtdHist implements Serializable {
	 ...
	 * 还款间隔
	 */
	private Long paymFreqFreq;
	/**
	 * 从第几期
	 */
	private Long frmPerd;
	/**
	 * 到第几期
	 */
	private Long toPerd;
	 ...
	 * 递增还款周期
	 */
	private Long pgsPrcpFreq;
	/**
	 * 实际计算期数
	 */
	private Long calTotInstm;
	/**
	 * 本金比例
	 */
	 ...
	 * 设置：还款间隔
	 */
	public void setPaymFreqFreq(Long paymFreqFreq) {
		this.paymFreqFreq = paymFreqFreq;
	}
	/**
	 * 获取：还款间隔
	 */
	public Long getPaymFreqFreq() {
		return paymFreqFreq;
	}
	/**
	 * 设置：从第几期
	 */
	public void setFrmPerd(Long frmPerd) {
		this.frmPerd = frmPerd;
	}
	/**
	 * 获取：从第几期
	 */
	public Long getFrmPerd() {
		return frmPerd;
	}
	/**
	 * 设置：到第几期
	 ...
	 * 设置：递增还款周期
	 */
	public void setPgsPrcpFreq(Long pgsPrcpFreq) {
		this.pgsPrcpFreq = pgsPrcpFreq;
	}
	/**
	 * 获取：递增还款周期
	 */
	public Long getPgsPrcpFreq() {
		return pgsPrcpFreq;
	}
	/**
	 * 设置：实际计算期数
	 */
	public void setCalTotInstm(Long calTotInstm) {
		this.calTotInstm = calTotInstm;
	}
	/**
	 * 获取：实际计算期数
	 */
	public Long getCalTotInstm() {
		return calTotInstm;
	}
	/**
	 * 设置：本金比例
